...
def main(args):
    ...
    dataset.feats = feats
    model = SIGN.load_from_checkpoint(model_ckpt_path, dataset=dataset, device=device, steps_per_epoch=len(datamodule.train_dataloader()))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_dir', type=str, default='./logs/sign_v1/base_L4/')
...
# python -m srcs.SIGN.sign_save_pred 
